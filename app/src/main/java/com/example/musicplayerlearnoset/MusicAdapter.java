...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull MusicAdapter.MyViewHolder holder, @SuppressLint(
        ...
        String generateDuration = String.format(Locale.getDefault(), "%02d:%02d",
                TimeUnit.MILLISECONDS.toMinutes(list2.getDuration()),
                TimeUnit.MILLISECONDS.toSeconds(list2.getDuration()) -
                TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes((list2.getDuration()))));
